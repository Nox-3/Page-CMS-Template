$(function(){
	...
	function initialize() {
	  ...
	  var mapProp = {
	    center:new google.maps.LatLng(-19.912998,-43.940933),
	    zoom:14,
	   	scrollwheel: false,
	     styles: [{
	    stylers: [{
	...
	$('nav.mobile').click(function(){
		//O que vai acontecer quando clicar no nav.mobile
	...
	if($('target').length > 0){
		//O elemento existe, portanto precisa dar o scroll em algum elemento.
	...
	function carregarDinamico(){
		$('[realtime]').click(function(){
			...
			$('.container-principal').load(include_path+'pages/'+pagina+'.php',function(){
				...
				initialize();
				addMarker(-19.912998,-43.940933,'',"Local",undefined,false);

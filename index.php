...
<base base="<?php echo INCLUDE_PATH; ?>" />
	...
	<header>
		<div class="center">
			<div class="logo left"><a href="<?php echo INCLUDE_PATH; ?>">"Lorem Ipsum"</a></div><!--logo-->
			<nav class="desktop right">
				<ul>
					<li><a title="Home" href="<?php echo INCLUDE_PATH; ?>">Pagina Inicial</a></li>
			 ...
			 <nav class="mobile right">
				...
				<ul>
					<li><a href="<?php echo INCLUDE_PATH; ?>">Pagina Inicial</a></li>
